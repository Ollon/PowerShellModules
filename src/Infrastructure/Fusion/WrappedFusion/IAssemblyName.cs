// -----------------------------------------------------------------------
// <copyright file="IAssemblyName.cs" company="Ollon, LLC">
...
namespace PowerShell.Infrastructure.Fusion.WrappedFusion
{
    ...
    internal interface IAssemblyName
    {
        ...
        ///     added or to be modified. Valid property IDs are defined in the <see cref="AssemblyNamePropertyId" /> enumeration.
        /// </param>
        ...
        ///     Specified property IDs are defined in the <see cref="AssemblyNamePropertyId" /> enumeration.
        /// </param>
        ...
        ///     Values are one or more of the bits defined in the AssemblyCompareFlags enumeration.
        /// </param>
        /// <returns></returns>
        [PreserveSig]
        int IsEqual(
